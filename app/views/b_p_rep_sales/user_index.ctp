...
<?php
	echo $this->element('search_forms/b_p_rep_sales', array('url' => array('controller' => 'b_p_rep_sales', 'action' => 'index')));
...
<?php } else { ?>
<?php echo $this->element('b_p_rep_sales/index_table', array('rep_tab' => 6, 'b_p_tab' => 18))?>
<?php } ?>
