...
<?php
	echo $this->element('search_forms/c_s_rep_transactions', array('url' => array('controller' => 'c_s_rep_transactions', 'action' => 'index')));
...
<?php } else { ?>
<?php echo $this->element('c_s_rep_transactions/index_table', array('rep_tab' => 8, 'b_p_tab' => 20))?>
<?php } ?>