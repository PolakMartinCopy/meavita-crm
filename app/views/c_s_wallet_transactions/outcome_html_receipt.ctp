		...
		<td colspan="2">
			<table width="100%">
				...
				<tr>
					...
					<td width="40%"></td>
					<td width="5%">Kč</td>
					<td width="15%"><?php echo round($c_s_wallet_transaction['CSWalletTransaction']['amount'])?></td>
					<td width="5%">h</td>
					<td width="15%">-</td>
				</tr>
				<tr>
					<td>Slovy:</td>
					<td colspan="5"><?php echo convert_number($c_s_wallet_transaction['CSWalletTransaction']['amount'])?>korunčeských</td>
				</tr>
				<tr>
					<td>Účel výplaty</td>
					<td colspan="5">&nbsp;</td>
