...
<?php
	echo $this->element('search_forms/b_p_rep_purchases', array('url' => array('controller' => 'b_p_rep_purchases', 'action' => 'index')));
...
<?php } else { ?>
	<?php echo $this->element('b_p_rep_purchases/index_table', array('rep_tab' => 4, 'b_p_tab' => 19))?>
