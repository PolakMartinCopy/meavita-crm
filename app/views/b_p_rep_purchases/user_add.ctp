...
<table class="left_heading">
	<tr>
		...
		<td colspan="10"><?php 
			if (isset($rep)) {
				...
				echo $this->Form->input('BPRepPurchase.rep_name', array('label' => false, 'size' => 50));
	...
	<tr>
		...
		<td colspan="10"><?php 
			echo $this->Form->input('BPRepPurchase.business_partner_name', array('label' => false, 'size' => 50));
	...
	<tr rel="0">
		...
		<td>
			...
			<?php echo $this->Form->hidden('BPRepTransactionItem.0.product_id')?>
		</td>
		<th>LOT</th>
		<td><?php echo $this->Form->input('BPRepTransactionItem.0.product_variant_lot', array('label' => false, 'size' => 7))?></td>
		<th>EXP</th>
		<td><?php echo $this->Form->input('BPRepTransactionItem.0.product_variant_exp', array('label' => false, 'size' => 7))?></td>
		<th>Množství</th>
	...
	<tr rel="<?php echo $index?>">
		...
		<td>
			...
			<?php echo $this->Form->hidden('BPRepTransactionItem.' . $index . '.product_id')?>
		</td>
		<th>LOT</th>
