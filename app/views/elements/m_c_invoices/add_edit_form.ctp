	...
	<tr>
		...
		<td colspan="4"><?php 
			if (isset($business_partner)) {
				echo $this->Form->input('MCInvoice.business_partner_name', array('label' => false, 'size' => 50, 'disabled' => true));
			} else {
				echo $this->Form->input('MCInvoice.business_partner_name', array('label' => false, 'size' => 50));
				echo $this->Form->error('MCInvoice.business_partner_id');
			}
			echo $this->Form->hidden('MCInvoice.business_partner_id')
		?></td>
	</tr>
	<tr>
		<th>Datum splatnosti</th>
		<td colspan="4">
			<?php echo $this->Form->input('MCInvoice.due_date', array('label' => false, 'type' => 'text', 'div' => false))?>
		</td>
	</tr>
	<tr>
		<th>Číslo objednávky</th>
		<td><?php echo $this->Form->input('MCInvoice.order_number', array('label' => false))?></td>
	</tr>
	<tr>
		<th>Jazyk</th>
		<td><?php echo $this->Form->input('MCInvoice.language_id', array('label' => false))?></td>
	</tr>
	<tr>
		<th>Měna</th>
		<td><?php echo $this->Form->input('MCInvoice.currency_id', array('label' => false))?></td>
	</tr>
	<tr>
		<th>Poznámka</th>
		<td><?php echo $this->Form->input('MCInvoice.note', array('label' => false, 'cols' => 60, 'rows' => 5))?></td>
	</tr>
</table>
<h2>Položky</h2>
...
<?php if (empty($this->data['MCTransactionItem'])) { ?>
	<tr rel="1" class="product_row">
		<td><?php
			echo $this->Form->input('MCTransactionItem.1.product_name', array('label' => false, 'size' => 50, 'class' => 'MCTransactionItemProductName'));
			echo $this->Form->error('MCTransactionItem.1.product_variant_id');
			echo $this->Form->hidden('MCTransactionItem.1.product_variant_id')
		?></td>
