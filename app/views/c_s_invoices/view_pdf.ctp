...
$products_table .= '
	...
	<tr>
		...
		<td align="right"><strong>' . format_price($invoice['CSInvoice']['amount_vat']) . ' ' . $invoice['Currency']['shortcut'] . '</strong></td>
	</tr>
</table>
';
...
$tax_table = '
	<table cellspacing="0" cellpadding="1" border="0" style="width:100%">
		<tr>
			<td style="width:30%" align="right">sazba DPH</td>
			<td style="width:35%" align="right">základ</td>
			<td style="width:35%" align="right">DPH</td>
		</tr>
';
...
<table cellspacing="0" cellpadding="5" border="0">
	<tr>
		<td align="left" style="font-size:40px"><strong>Faktura č.</strong></td>
	...
	<tr>
		<td colspan="2" style="border:0.5px solid black">Zboží zůstává až do úplného uhrazení kupní ceny majetkem společnosti MeaVita s.r.o.  Dovolujeme si Vás upozornit, že v případě nedodržení data splatnosti uvedeného na faktuře, Vám budeme účtovat úrok z prodlení v dohodnuté, resp. zákonné výši.</td>
	</tr>
</table>';
