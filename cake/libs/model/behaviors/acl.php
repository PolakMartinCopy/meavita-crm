 ...
 */
	function node(&$model, $ref = null) {
		...
		if ($model_name == 'Rep' || $model_name == 'CSRep') {
			$model_name = 'User';
		}
		$type = $this->__typeMaps[$this->settings[$model_name]['type']];
		if (empty($ref)) {
			$ref = array('model' => $model_name, 'foreign_key' => $model->id);
		}
 ...
 */
	function afterSave(&$model, $created) {
		...
		$alias = $model->alias;
		if ($model->alias == 'Rep' || $model->alias == 'CSRep') {
			$alias = 'User';
		}
		$data = array(
